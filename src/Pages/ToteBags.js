...
function ToteBags() {
  const [category] = useState("TOTEBAG");
  ...
  useEffect(() => {
    if (category === "TOTEBAG") {
      const FilterProduct = products.filter(item => item.category === "ToteBag");
  ...
  return (
    <Helmet title="Tote-Bags">
      <>
        <section className='container-fluid m-0 p-0'>
          <img alt='' src='assets/img/TOTE_BAGS.webp' className='img-fluid'></img>
        </section>
