              ...
              <div className="offcanvas offcanvas-start" tabindex="-1" id="offcanvasExample" aria-labelledby="offcanvasExampleLabel">
                ...
                <div className="offcanvas-body">
                  ...
                  <div>
                    ...
                    <li>
                      <Link to="/seller" className='fw-bolder'><i className="fa-solid fa-angles-right pe-2"></i>BEST SELLER</Link>
                    </li>
                    <li>
                      ...
                      <ul className="collapse" aria-labelledby="navbarDropdown" id="collapseExample">
                        ...
                        <li><Link className="dropdown-item" to="">Clutches</Link></li>
                        <li><Link className="dropdown-item" to="">Wallet & Card Holders</Link></li>
                        <li><Link className="dropdown-item" to="">View all</Link></li>
                      </ul>
                    </li>
                    <li>
                      <Link to="" className='fw-bolder'><i className="fa-solid fa-angles-right pe-2"></i>FEATURED COLLECTIONS</Link>
                      ...
                      <ul className="collapse" aria-labelledby="navbarDropdown" id="collapseExample1">
                        <li><Link className="dropdown-item" to="/collection">Love Collections'24</Link></li>
                    ...
                    <li>
                      <Link to="" className='fw-bolder'><i className="fa-solid fa-angles-right pe-2"></i>CURATED</Link>
                      ...
                      <ul className="collapse" aria-labelledby="navbarDropdown"  id="collapseExample2">
                        <li><Link className="dropdown-item" to="/curated">Office Essentials</Link></li>
                    ...
                    <li>
                      <Link to="" className='fw-bolder'><i className="fa-solid fa-angles-right pe-2"></i>EDITORIAL</Link>
                      ...
                      <ul className="collapse" aria-labelledby="navbarDropdown" id="collapseExample3">
                        <li><Link className="dropdown-item" to="/editorial">Fashion</Link></li>
                    ...
                    <li>
                      <Link to="/cart" className='fw-bolder'><i className="fa-solid fa-angles-right pe-2"></i>CART</Link>
                    </li>
                    </ul>
                  </div>
                </div>
              ...
              <div className="container-fluid">
                ...
                <div className="collapse navbar-collapse" id="navbarSupportedContent">
                  <ul className="navbar-nav me-auto mb-2 mb-lg-0">
                    ...
                    <li className="nav-item dropdown">
                      <Link className="nav-link active dropdown_title" to="" id="navbarDropdown" role="button"   data-bs-toggle="dropdown" aria-expanded="false">FEATURED COLLECTIONS</Link>
                      <ul className="dropdown-menu dropdown-content" aria-labelledby="navbarDropdown">
                        <li><Link className="dropdown-item" to="/collection">Love Collections'24</Link></li>
                        <li><Link className="dropdown-item" to="">Miraggion & Deme</Link></li>
                        <li><Link className="dropdown-item" to="">Cocktail Collection</Link></li>
                    ...
                    <li className="nav-item dropdown">
                      <Link className="nav-link active dropdown_title" to="" id="navbarDropdown" role="button"   data-bs-toggle="dropdown" aria-expanded="false">CURATED</Link>
                      <ul className="dropdown-menu dropdown-content" aria-labelledby="navbarDropdown">
                        <li><Link className="dropdown-item" to="/curated">Office Essentials</Link></li>
                        <li><Link className="dropdown-item" to="">Party Edit</Link></li>
                        <li><Link className="dropdown-item" to="">Gifts for Her</Link></li>
                    ...
                    <li className="nav-item dropdown">
                      <Link className="nav-link active dropdown_title" to="" id="navbarDropdown" role="button" data-bs-toggle="dropdown" aria-expanded="false">EDITORIAL</Link>
                      <ul className="dropdown-menu dropdown-content" aria-labelledby="navbarDropdown">
                        <li><Link className="dropdown-item" to="/editorial">Fashion</Link></li>
                        <li><Link className="dropdown-item" to="">Muses</Link></li>
                        <li><Link className="dropdown-item" to="">Collection</Link></li>
